#!/usr/bin/env bash
#
# setup-simple.sh - simplified setup for Resume Matcher (without Ollama)
#
# Usage:
#   ./setup-simple.sh [--help] [--start-dev]
#
# This script will:
...
#   • Skip Ollama installation (you can install it manually later if needed)
...
info "Skipping Ollama installation for now. You can install it manually later if needed."
info "Note: The application will not work with LLM features until Ollama is installed and configured."
...
Next steps:
  ...
  • To enable LLM features, install Ollama manually: https://ollama.com/
